      ...
      <Container size="lg" paddingVertical="$10">
        <Column gap="$2xl">
          ...
          <Column gap="$xl">
            <Column gap="$md">
              <Text size="$6">
                Welcome to ButterGolf. By accessing and using our marketplace platform, you agree to
            ...
            <Column gap="$md">
              ...
              <Text>
                By creating an account, listing items for sale, purchasing items, or otherwise using
                ButterGolf, you agree to comply with and be legally bound by these Terms of Service.
            ...
            <Column gap="$md">
              ...
              <Text>
                You must be at least 18 years old to use ButterGolf. By using our platform, you
                represent and warrant that you are of legal age to form a binding contract and are
                not prohibited from accessing or using our services under applicable law.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                notify us of any unauthorised use of your account. ButterGolf reserves the right to
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm">
                ...
                <Text>
                  Sellers are responsible for accurately describing their items, setting fair
                  prices, and fulfilling orders in a timely manner. All golf equipment must be
                  genuine and in the condition described. Misrepresentation of items may result in
                  account suspension.
                </Text>
              </Column>
              <Column gap="$sm">
                ...
                <Text>
                  Buyers agree to pay for items they purchase and to communicate respectfully with
                  sellers. Disputes should be resolved through our messaging system or with the
                  assistance of ButterGolf support.
                </Text>
              </Column>
              <Column gap="$sm">
                <Text fontWeight="600">4.3 Platform Fees</Text>
                <Text>
                  ButterGolf charges a service fee on completed transactions. The current fee
                  structure is displayed during the listing process. We reserve the right to modify
            ...
            <Column gap="$md">
              ...
              <Text>
                All payments are processed securely through our payment provider. Refunds are
                handled according to our Refund Policy and are subject to the condition of returned
                items. ButterGolf is not liable for disputes between buyers and sellers but will
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm" paddingLeft="$lg">
                ...
                <Text>• Engage in fraudulent transactions or payment schemes</Text>
                <Text>• Harass, threaten, or abuse other users</Text>
                <Text>• Attempt to circumvent platform fees or payment systems</Text>
                <Text>• Use automated systems to scrape or manipulate the platform</Text>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                trademark laws. You may not use, reproduce, or distribute our content without
                written permission.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                display, and distribute that content in connection with operating our platform. You
                represent that you own or have the necessary rights to any content you post.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                legality of items listed. THE PLATFORM IS PROVIDED &quot;AS IS&quot; WITHOUT
                WARRANTIES OF ANY KIND. TO THE MAXIMUM EXTENT PERMITTED BY LAW, BUTTERGOLF SHALL NOT
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                arbitration association. You waive your right to participate in class action
                lawsuits.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                will notify users of material changes via email or platform notification.
              </Text>
            </Column>
