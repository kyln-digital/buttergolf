      ...
      <Container size="lg" paddingVertical="$10">
        <Column gap="$2xl">
          ...
          <Column gap="$xl">
            <Column gap="$md">
              <Text size="$6">
                At ButterGolf, we are committed to protecting your privacy and ensuring the security
                of your personal information. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your data when you use our marketplace platform.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm">
                ...
                <Text>
                  When you create an account, list items, or make purchases, we collect information
                  such as your name, email address, payment information, shipping address, and any
                  other details you provide. We also collect information from your communications
              ...
              <Column gap="$sm">
                ...
                <Text>
                  ...
                  including your IP address, browser type, device information, pages viewed, and
                  usage patterns. We use cookies and similar technologies to collect this data.
                </Text>
              </Column>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm" paddingLeft="$lg">
                <Text>• Facilitate transactions between buyers and sellers</Text>
                <Text>• Process payments and prevent fraud</Text>
                <Text>• Communicate with you about your account and transactions</Text>
                <Text>• Improve and personalise your experience on our platform</Text>
                <Text>• Send marketing communications (with your consent)</Text>
                <Text>• Comply with legal obligations and enforce our terms</Text>
                <Text>• Analyse usage patterns to improve our services</Text>
              </Column>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm">
                ...
                <Text>
                  When you list items or make purchases, certain information (such as your username
                  and ratings) is visible to other users to facilitate transactions.
                </Text>
              </Column>
              <Column gap="$sm">
                ...
                <Text>
                  ...
                  platform, including payment processors, hosting providers, and analytics services.
              ...
              <Column gap="$sm">
                ...
                <Text>
                  We may disclose your information when required by law, to protect our rights, or
            ...
            <Column gap="$md">
              ...
              <Text>
                We use cookies, web beacons, and similar technologies to track user activity and
                enhance your experience. You can control cookie preferences through your browser
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                agreements. You may request deletion of your account and associated data at any
                time.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Column gap="$sm" paddingLeft="$lg">
                <Text>• Access, correct, or delete your personal information</Text>
                <Text>• Object to or restrict certain processing of your data</Text>
                <Text>• Opt out of marketing communications</Text>
                <Text>• Request data portability</Text>
                <Text>• Withdraw consent where processing is based on consent</Text>
              </Column>
              <Text>To exercise these rights, contact us at privacy@buttergolf.com.</Text>
            </Column>

            <Column gap="$md">
              <Heading level={2}>8. Children&apos;s Privacy</Heading>
              <Text>
                ButterGolf is not intended for users under the age of 18. We do not knowingly
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                own. These countries may have different data protection laws, but we ensure
            ...
            <Column gap="$md">
              ...
              <Text>
                If you are in the European Economic Area, you have additional rights under the
                General Data Protection Regulation (GDPR), including the right to lodge a complaint
                with a supervisory authority. We process your data based on legitimate interests,
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                request deletion of their information, and opt out of the sale of their information.
                ButterGolf does not sell personal information.
              </Text>
            </Column>
            ...
            <Column gap="$md">
              ...
              <Text>
                ...
                changes by posting the updated policy on our platform and updating the &quot;Last
                updated&quot; date. Continued use of ButterGolf after changes are posted constitutes
