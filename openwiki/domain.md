...
| Auth                    | `apps/web/src/app/api/clerk/`, `apps/mobile/features/auth/`                                                                                                                                               | Clerk-based auth, webhook sync                         |
